...
export default class ScorecardPolitical extends React.Component {
  ...
  componentDidMount() {
    axios.get('https://sheets.googleapis.com/v4/spreadsheets/1d8HRGJU8p8tHDoTiSnVbqZuHTW9lSeqG-dWMyeC-v3E/values/newsb?key=AIzaSyBGuGESLGgBsWAb_TUAkE0weCji4sCa_bU')
      .then(res => {
        console.log(res);
